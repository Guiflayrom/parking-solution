...
#url = 'cams/cam3/4AY1DXQ9XSOJSCVQF.jpg'
# exemplo: rtsp://199.234.167.151:554/onvif/profile1/media.smp
count = 0

imgs = glob("cams/cam2/*.jpg")
#imgs = glob("teste/*.jpg")
...
while True:
	#save = True
	count += 1
	frame = cv2.imread('16X138TXA5VVBBPIF.jpg')
	...
	if  k == ord('s') or count % intervalo == 0 :
		save = True
